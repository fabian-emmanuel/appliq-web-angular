...
@Component({
  selector: 'app-dashboard',
  imports: [RouterOutlet, MatFormField, MatDatepickerToggle, MatSelect, DatePipe, FormsModule, MatSelect, MatSelect, MatOption, NgxChartsModule, MatSelect, MatSelect, MatOption, MatLabel, MatRadioGroup, MatRadioButton, MatDateRangeInput, MatFormFieldModule, MatSelectTrigger, MatDatepickerModule],
  templateUrl: './dashboard.html',
  styleUrl: './dashboard.css',
  providers: [provideNativeDateAdapter()],
  changeDetection: ChangeDetectionStrategy.OnPush,
