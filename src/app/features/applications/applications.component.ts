...
import { ApplicationCardComponent } from '@layout/card/application-card/application-card.component';
...
@Component({
  ...
  imports: [RouterOutlet, CommonModule, FormsModule, NgIf, ApplicationCardComponent],
